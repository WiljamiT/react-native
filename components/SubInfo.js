...
export const AlbumTitle = ({ title, subTitle, titleSize, subTitleSize }) => {
  return (
    <View>
      ...
      <Text style={{ fontFamily: FONTS.regular, fontSize: subTitleSize, color: COLORS.primary }}>Myyjä: {subTitle}</Text>
    </View>
  )
}
...
export const People = () => {
    return (
      <View style={{ flexDirection: 'row' }}>
        {[assets.person05, assets.person02, assets.person04].map((imgUrl, index) => (
